...
public class JanelaPrincipal extends JFrame {
    ...
    public JanelaPrincipal() {
        ...
        itemSobre.addActionListener(e -> JOptionPane.showMessageDialog(
                this, "Sistema de Cadastro de Alunos\n" + "CRUD Completo\n" + "Versão 2.0"));
    ...
    private void atualizarAluno() {
        ...
        if (linha == -1) {
            JOptionPane.showMessageDialog(
                    this, "Selecione um aluno para atualizar."
            );
            return;
        }

        int id =
                (int) tabela.getValueAt(linha, 0);

        String novoNome =
                JOptionPane.showInputDialog("Novo nome:", tabela.getValueAt(linha, 1));

        String novoEmail =
                JOptionPane.showInputDialog("Novo email:", tabela.getValueAt(linha, 2));
